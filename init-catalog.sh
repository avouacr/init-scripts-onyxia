...
git clone https://$GIT_PERSONAL_ACCESS_TOKEN@github.com/InseeFrLab/docs.sspcloud.fr.git
git clone https://$GIT_PERSONAL_ACCESS_TOKEN@github.com/InseeFrLab/paris-sspcloud.git
